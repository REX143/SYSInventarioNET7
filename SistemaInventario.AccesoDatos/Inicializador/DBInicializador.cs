    ...
    public class DBInicializador : IDBInicializador
    {
        ...
        public void Inicializar()
        {
            ...
            _userManager.CreateAsync(new UsuarioAplicacion { 
                UserName = "heraldava@gmail.com",
                Email = "heraldava@gmail.com",
                EmailConfirmed= true,
                Nombres = "Admin",
                Apellidos = "GRUPO SAC",

            }, "N0meacuerd0").GetAwaiter().GetResult();

            // ASIGNAR ROL A USUARIO CREADO
            UsuarioAplicacion usuario = _db.UsuarioAplicacion!.Where(u => u.UserName == "heraldava@gmail.com").FirstOrDefault();
