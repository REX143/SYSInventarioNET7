...
{
    [Area("Inventario")]
    [Authorize(Roles = DS.Role_Cliente + "," + DS.Role_Inventario + "," + DS.Role_Admin)]
    public class InventarioController : Controller
    {
        ...
        public IActionResult NuevoInventario()
        {
            ...
            {
                Inventario = new Modelos.Admin.Inventario(),
        ...
        public async Task<IActionResult> GenerarStock(int id)
        {
            ...
            foreach (var item in detalleLista)
            {
                ...
                if (bodegaProducto != null) // registro de stock existe
                {
                    await _unidadTrabajo.KardexInventario.RegistrarKardex(bodegaProducto.Id, "Entrada",
                    ...
                    _unidadTrabajo.BodegaProducto.Actualizar(bodegaProducto);
                    await _unidadTrabajo.Guardar();
                } else // no existe registro de stock, crearlo
                {
        ...
        public async Task<IActionResult> KardexProductoResultado(string fechaInicioId, string fechaFinalId, int productoId)
        {
            ...
            kardexInventarioVM.FechaFinal = DateTime.Parse(fechaFinalId).AddHours(23).AddMinutes(59).AddSeconds(59);

            kardexInventarioVM.KardexInventarioLista = await _unidadTrabajo
                                                             .KardexInventario.ObtenerTodos
        ...
        public async Task<IActionResult> ImprimirKardex(string fechaInicio, string fechaFinal, int productoId)
        {
            ...
            kardexInventarioVM.FechaFinal = DateTime.Parse(fechaFinal).AddHours(23).AddMinutes(59).AddSeconds(59);
