    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pageNumber = 1, string busqueda ="", string busquedaActual="")
        {
            ...
            if (claim!=null)
            {
                ...
                var numeroProductos = carroLista.Count(); // # de registros
            ...
            if (!String.IsNullOrEmpty(busqueda))
            {
                resultado = _unidadTrabajo.Producto.ObtenerTodosPaginado(parametros, p => p.Descripcion.Contains(busqueda) || p.Categoria.Descripcion!.Contains(busqueda));
            }
