...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class CompaniaController : Controller
    {
        ...
        public async Task<IActionResult> Upsert()
        {
            ...
            {
                Compania = new Modelos.Admin.Compania(),
            ...
            {
                companiaVM.Compania = new Modelos.Admin.Compania();
            }
        ...
        public async Task<IActionResult> Upsert(CompaniaVM companiaVM)
        {
            if (ModelState.IsValid)
            {
                ...
                if (companiaVM.Compania.Id == 0) // crear nueva compañia
                {
            ...
            TempData[DS.Error] = "Error al grabar la compañia";
            return View(companiaVM);
        }
