        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await _userManager.AddToRoleAsync(user, DS.Role_Admin); Para crear por primera vez
                    if (user.Role == null)
                    {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirma tu email",
                        $"Confirmar tu cuentta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'> click en el enlace.</a>.");
