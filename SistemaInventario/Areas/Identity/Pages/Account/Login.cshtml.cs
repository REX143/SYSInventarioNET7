        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var nroProductos = carroLista.Count();
                    HttpContext.Session.SetInt32(Utilidades.DS.ssCarroCompras, nroProductos);
                ...
                {
                    ModelState.AddModelError(string.Empty, "La cuenta aún no ha sido verificada. Revise su bandeja de correo y confirme la cuenta.");
                    return Page();
                }
            }
